...
NORM1	RST  10H		; Get user character
	...
	SUB  $41		; Take values from ascii A-U down to 0-20 decimal
...
;------------------------------------------------------------------------------
CMDTBL	.WORD	RST00	; <A> $0000 RESET
...
CKSUMERR	.BYTE	"Checksum Error"
	.BYTE	$0D,$0A,$00
;------------------------------------------------------------------------------
LCDTXT1	.BYTE	"Z-80 Monitor Rom - Rev 9.0"
	.BYTE	$00
